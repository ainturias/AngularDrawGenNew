...
export const useAngularProjectGenerator = (roomName: string) => {
  const generateAngularProject = useMutation(async ({ storage }) => {
    try {
      ...
      // Generar el archivo .bat para instalación
      const generateInstallBat = () => {
        return `@echo off
      echo =====================================
      echo  Instalador de Paquetes Angular
      echo =====================================
      echo.
      ...
      IF %ERRORLEVEL% EQU 0 (
          ...
          echo Visual Studio Code no está instalado o 'code' no está en PATH.
      )
      ...
      const angularProject = {
        ...
        'instalar_y_correr.bat': generateInstallBat() // Archivo .bat para instalación
      };
